...
\begin{titlepage}
	...
	%\includegraphics[scale=0.4]{graphics/croc.png}\\[1cm] % Include a department logo
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{ex_sig_gen}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{nsub}
